...
<html lang="pt-br">
  ...
  <div class="container-fluid">
    ...
    <div class="card" style="width: 18rem;">
        <img src="<?= BASEURL; ?>/image/ical.jpg" class="card-img-top" alt="...">
        <div class="card-body">
            <h3>Fatimah Alfiatul Jannah</h3>
            <p class="card-text">G64190014</p>
        </div>
    </div>
    <div class="card" style="width: 18rem;">
        <img src="<?= BASEURL; ?>/image/ical.jpg" class="card-img-top" alt="...">
        <div class="card-body">
            <h3>Faisal Ibrahim Abusalam</h3>
            <p class="card-text">G64190054</p>
        </div>
    </div>
    <div class="card" style="width: 18rem;">
        <img src="<?= BASEURL; ?>/image/ical.jpg" class="card-img-top" alt="...">
        <div class="card-body">
            <h3>Rizal Mujahiddan</h3>
            <p class="card-text">G64190069</p>
        </div>
    </div>
    <div class="card" style="width: 18rem;">
        <img src="<?= BASEURL; ?>/image/ical.jpg" class="card-img-top" alt="...">
        <div class="card-body">
            <h3>Fathin Humaira</h3>
            <p class="card-text">G64190070</p>
        </div>
    </div>
    <div class="card" style="width: 18rem;">
        <img src="<?= BASEURL; ?>/image/ical.jpg" class="card-img-top" alt="...">
        <div class="card-body">
            <h3>Dwayne Cameron Sjahid</h3>
            <p class="card-text">G64190085</p>
        </div>
    </div>
