          ...
          <input type="hidden" id="jk" name="jk" value="betina">
            ...
            <div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="susu" name="susu" placeholder="Dalam Liter" value="" autocomplete="off" required>
						</div>
					</div>
                    ...
                    <div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="rambut" name="rambut" placeholder="Dalam kg" value="" autocomplete="off" required>
						</div>
					</div>
